...
import type { JudgeAssistantResponse, JudgeClarification } from "#/server/judge";
...
export type GetJudgeResponseInput = {
  message: string;
...
export function JudgeChat({ getResponse }: JudgeChatProps) {
