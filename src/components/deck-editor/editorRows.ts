import { CARD_CATEGORIES, type CardCategory, mergeValidatedCards, type ValidatedDeckCard } from '../../lib/decklist'
import type { EditorRow } from './types'

export function buildEditorRows(baselineCards: ValidatedDeckCard[], workingCards: ValidatedDeckCard[]) {
